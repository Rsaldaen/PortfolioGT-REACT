...
export default function Projects() {
  return (
    ...
    <div> 
      <Card className='center' sx={{ maxWidth: 650, maxHeight: 800}}>
        <CardContent >
        ...
        <p className='projecttext'>With the app the user can sign-up, login, and generate a workout with exercises/set/reps, by simply choosing a day of the week and a body part focused workout.</p>
        </CardContent>
      </Card>
      <Card className='center' sx={{ maxWidth: 650, maxHeight: 800}}>
        <CardContent >
        ...
        <p className='marginbtm projecttext'>App where user will be able to select their daily mood and be given a random dad joke and motivational quote followed by the option to log a journal entry.</p>
        </CardContent>
      </Card>
      <br></br>
      <br></br>
